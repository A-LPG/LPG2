...
| Document | Audience |
|----------|----------|
| [QUICKSTART.md](QUICKSTART.md) | First run (calculator in ~5 minutes) |
| [CONCEPTS.md](CONCEPTS.md) | Mental model: generator / templates / runtime |
| [tutorial.md](tutorial.md) | Hands-on calculator walkthrough |
