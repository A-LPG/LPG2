...
void JavaTable::print_symbols(void) {
    ...
    {
        fprintf(syssym, "    public final static int\n");
        ...
        fprintf(syssym, "\n    public final static int numTokenKinds = %d;\n\n", grammar->num_terminals);
    ...
    if(option->automatic_ast != Option::NONE)
    {
        ...
        for (int rule_no = grammar->FirstRule()+1; rule_no <= grammar->LastRule(); rule_no++) {
            ...
            strcpy(sym_line, "    public final static int ");
        ...
        fprintf(syssym, "\n    public final static int numRuleNames = %d;\n\n", grammar->LastRule());
