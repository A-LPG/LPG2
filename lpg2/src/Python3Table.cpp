...
//
//
void Python3Table::PrintHeader(const char *, const char *name, const char *initial_elements)
{
...
//
//
void Python3Table::PrintTrailer()
{
    prs_buffer.Put("        ]\n");
}
...
//
//
void Python3Table::PrintTrailerAndVariable(const char *, const char *)
{
    PrintTrailer();
    return;
}
...
//
//
void Python3Table::PrintIntsSubrange(int init, int gate, Array<int> &array)
{
    prs_buffer.Pad();
    int k = 0;
...
//
//
void Python3Table::Print(IntArrayInfo &array_info)
{
...
//
//
void Python3Table::non_terminal_action(void)
{
    char  temp[1024] = {};
    sprintf(temp, "    #/**\n"
            "     # assert(goto_default)\n"
...
//
//
void Python3Table::non_terminal_no_goto_default_action(void)
{
    char  temp[1024] = {};
    sprintf(temp, "    #/**\n"
                   "     # assert(! goto_default)\n"
...
//
//
void Python3Table::terminal_action(void)
{
    char  temp[1024] = {};
    sprintf(temp, "    #/**\n"
...
//
//
void Python3Table::terminal_shift_default_action(void)
{
    char  temp[1024] = {};
    sprintf(temp, "    #/**\n"
                   "     #* assert(shift_default)\n"
...
//
//
void Python3Table::init_parser_files(void)
{
...
//
//
void Python3Table::exit_parser_files(void)
{
...
//
//
void Python3Table::print_exports(void)
{
...
//
//
void Python3Table::print_definition(const char *variable, const char *method, int value)
{
...
//
//
void Python3Table::print_definition(const char *variable, const char *method, bool value)
{
...
//
//
void Python3Table::print_definitions(void)
{
...
//
//
void Python3Table::print_externs(void)
{
...
//
//
void Python3Table::print_source_tables(void)
{
    ...
    if (grammar -> recovers.Length() > 0)
    {
        char temp[1024] = {};
        sprintf(temp,
            "    def getProsthesisIndex(self, index: int) -> int: "
...
//
//
void Python3Table::PrintTables(void)
{
    init_parser_files();
