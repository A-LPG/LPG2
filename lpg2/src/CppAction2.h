#ifndef CppAction2_INCLUDED
#define CppAction2_INCLUDED

#include "Action.h"
#include "control.h"

class CppAction2 : public Action
{
public:

    CppAction2(Control *control_, Blocks *action_blocks_, Grammar *grammar_, MacroLookupTable *macro_table_)
