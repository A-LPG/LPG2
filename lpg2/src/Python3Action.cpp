...
//
TextBuffer *Python3Action::AstCodeBuffer(ActionFileSymbol *file)
{
    return GetBuffer(file);
}

void Python3Action::EmitAstClassCloser(TextBuffer &code_buf, ActionFileSymbol * /*top_level_file*/, bool /*list_extension_closer*/)
{
    code_buf.Put("    \n\n");
}

void Python3Action::MaybeEmitAstRootInterface(ActionFileLookupTable &ast_filename_table,
                                 ...
                                 const char *classname)
{
    ...
    {
	    b.Put(indentation); b.Put("    def getNextAst(self) -> IAst : return None\n");
    }
...
void Python3Action::EmitRecoverProstheticNull(TextBuffer &b, const char * /*type_name*/) const
{
    b.Put("None");
}
