...
//
TextBuffer *TypeScriptAction::AstCodeBuffer(ActionFileSymbol *file)
{
    return GetBuffer(file);
}

void TypeScriptAction::EmitAstClassCloser(TextBuffer &code_buf, ActionFileSymbol * /*top_level_file*/, bool /*list_extension_closer*/)
{
    code_buf.Put("    }\n\n");
}

void TypeScriptAction::MaybeEmitAstRootInterface(ActionFileLookupTable &ast_filename_table,
...
//
// Emit getProstheticAst(): the factory array consumed by the backtracking
// parser to synthesize a placeholder node for a replayed %Recover nonterminal
// ErrorToken instead of throwing a BadParseException. Uses an inline function
// type (structurally identical to the runtime ProstheticAst) so the generated
// module needs no extra import.
//
void TypeScriptAction::EmitProstheticAstFactories(ActionFileSymbol *default_file_symbol)
{
    ...
    const char *fn_type = "((errorToken : IToken) => IAst) | null";
    ...
    b.Put("\n    //\n"
          ...
          "    //\n");
    b.Put("    public getProstheticAst() : Array<");
    b.Put(fn_type);
    b.Put("> {\n");
    b.Put("        let prostheticAst : Array<");
    b.Put(fn_type);
    b.Put("> = new Array<");
    b.Put(fn_type);
    b.Put(">(");
                                             ...
                                             Array<const char *> &, int rule_no)
{
    ...
    GenerateTerminalGcDeleteReminder(b, space, rule_no, allocation_element, "this.getRhsSym(1)");
