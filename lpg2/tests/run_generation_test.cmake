...
if(CHECK_RUST)
    ...
    if(RUST_PARSER)
        ...
        # automatic_ast=toplevel: include! sidecar + satellite AST .rs files
        set(_rust_ast_includes "${OUT_DIR}/${EXPECT_PREFIX}_ast_includes.rs")
        if(EXISTS "${_rust_ast_includes}")
            file(COPY "${_rust_ast_includes}" DESTINATION "${_rust_src}")
        endif()
        if(EXISTS "${OUT_DIR}/ast")
            file(COPY "${OUT_DIR}/ast" DESTINATION "${_rust_src}")
        endif()
    endif()
