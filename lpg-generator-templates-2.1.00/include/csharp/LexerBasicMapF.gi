%Headers
    ...
    /.
       ...
       public  bool printTokens=false;
        ...
        public $action_type(string filename) : this(filename, ECLIPSE_TAB_VALUE)
        {
        ...
        public override string[] orderedExportedSymbols() { return $exp_type.orderedTerminalSymbols; }

        public $super_stream_class(string filename, int tab) :base(filename, tab)
        {
            
        }

        public $super_stream_class(char[] input_chars, string filename, int tab): base(input_chars, filename, tab)
        {
           
        }
    
        public $super_stream_class(char[] input_chars, string filename): base(input_chars, filename, 1)
        {
