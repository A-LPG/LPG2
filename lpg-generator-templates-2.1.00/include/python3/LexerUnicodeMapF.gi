...
/. 
        ...
        #
        #
        static   tokenKind : list=  [0]*(0x10000)   # 0x10000 == 65536
        ...
        def __init__(self, fileName: str, inputChars: str= None, tab: int= 4) :
...
%Headers
    ...
    /.
        ...
        def  initialize(self,filename : str,content : str = None) :
