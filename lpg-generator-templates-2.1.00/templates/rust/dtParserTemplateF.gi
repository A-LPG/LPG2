...
%Define
    ...
    /.
        ...
        pub fn reset_parse$entry_name(&mut self) {
            self.dt_parser()
                .reset_parser_entry($sym_type::$entry_marker);
        }
        ...
        pub fn parse$entry_name(
            ...
            match self
                .dt_parser()
                .parse_entry($sym_type::$entry_marker)
            {
                Ok(ast) => Ok(ast),
...
%Headers
    ...
    pub struct $action_type {
        ...
        dt_parser: Option<DeterministicParser<PrsStreamAdapter, $prs_type, $action_type$RuleProxy>>,
        unimplemented_symbols_warning: bool,
        prs_table: $prs_type,
    }

    impl $action_type {
        fn dt_parser(&mut self) -> &mut DeterministicParser<PrsStreamAdapter, $prs_type, $action_type$RuleProxy> {
        ...
        pub fn get_parser(
            &mut self,
        ) -> &mut DeterministicParser<PrsStreamAdapter, $prs_type, $action_type$RuleProxy> {
            self.dt_parser()
        }
