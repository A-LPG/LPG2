...
--
%Options programming_language=rust,margin=4,backtrack
...
%Define
    ...
    /.
        ...
        pub fn parse$entry_name(
            ...
            match self
                .bt_parser()
                .fuzzy_parse_entry($sym_type::$entry_marker, error_repair_count)
            {
                Ok(ast) => Ok(ast),
...
%Headers
    ...
    pub struct $action_type {
        ...
        bt_parser: Option<BacktrackingParser<PrsStreamAdapter, $prs_type, $action_type$RuleProxy>>,
        unimplemented_symbols_warning: bool,
        prs_table: $prs_type,
    }

    impl $action_type {
        fn bt_parser(&mut self) -> &mut BacktrackingParser<PrsStreamAdapter, $prs_type, $action_type$RuleProxy> {
        ...
        pub fn get_parser(
            &mut self,
        ) -> &mut BacktrackingParser<PrsStreamAdapter, $prs_type, $action_type$RuleProxy> {
            self.bt_parser()
        }
