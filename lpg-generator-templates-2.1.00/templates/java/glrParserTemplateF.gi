...
--
%Options programming_language=java,margin=4,glr
...
%Headers
    ...
    public class $action_type extends $super_class implements RuleAction$additional_interfaces
    {
        ...
        public $action_type()
        {
            try
            {
                glrParser = new GLRParser(prsStream, prsTable, (RuleAction) this);
            }
            catch (NotGLRParseTableException e)
            {
                throw new Error(new NotGLRParseTableException
                                    ("Regenerate $prs_type.java with -GLR option"));
            }
